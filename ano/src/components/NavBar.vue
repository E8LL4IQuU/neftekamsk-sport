          ...
          <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1"
            ...
            <PopoverPanel
              ...
              <div class="p-4">
                ...
                <!-- TODO: add styling -->
                <router-link to="/events" class="group relative flex items-center gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50">
                  Все мероприятия
                </router-link>
              </div>
            </PopoverPanel>
            ...
            <div class="space-y-2 py-6">
              <Disclosure as="div" class="-mx-3" v-slot="{ open }">
                ...
                <DisclosurePanel class="mt-2 space-y-2">
                  <DisclosureButton v-for="item in [...IRLEvents,]" :key="item.title" as="div"
                    class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                    <router-link :to="`/events/${item.ID}`" @click="mobileMenuOpen = false">{{ item.title }}</router-link>
                  </DisclosureButton>
                </DisclosurePanel>
              </Disclosure>
